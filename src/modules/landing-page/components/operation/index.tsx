...
export function Operation() {
  return (
    <section className="text-white py-10 bg-azure-primary w-full">
      <h2 className="text-5xl font-bold text-center mt-20 mb-12 px-2 sm:px-0">
      ...
      <div className="flex justify-center gap-8 py-10 px-4 flex-col sm:flex-row">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8 sm:gap-[20rem]">
          ...
          <div className="pt-4 pr-0 sm:pr-10 text-center sm:text-right">
            <h1 className="font-bold text-xl sm:text-4xl pb-4 sm:pb-10">Cadastro Simples:</h1>
            <p className="text-sm sm:text-xl pb-6 sm:pb-0 leading-relaxed">
      ...
      <div className="flex justify-center gap-8 py-10 px-4 flex-col sm:flex-row">
        <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-8 sm:gap-[20rem]">
          <div className="pt-4 pl-0 sm:pl-10 text-center sm:text-left">
            <h1 className="font-bold text-xl sm:text-4xl pb-4 sm:pb-10">FeedBack Constante:</h1>
            <p className="text-sm sm:text-xl pb-6 sm:pb-0 px-2 sm:px-0 leading-relaxed">
              Sua opinião nos guia: com <span className="font-bold">feedback constante</span>,<br className='hidden sm:block' />{' '}
              ajustamos cada detalhe para oferecer uma plataforma <br className='hidden sm:block' />
              cada vez mais eficiente, transparente e feita para você.
            </p>
          </div>
          <div className="w-full sm:w-1/2">
            <Image
