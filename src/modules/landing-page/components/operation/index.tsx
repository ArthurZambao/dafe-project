...
export function Operation() {
  const sections = [
    ...
    },
    {
      ...
      text: (
        <>
          <span className='font-bold'>Fique sempre por dentro das novidades da escola!</span> Comunicados importantes,
          como avisos sobre eventos, reuniões, mudanças no calendário e atualizações gerais, serão
          enviados diretamente para o seu celular ou computador. Assim, você não perde nenhuma
          informação relevante e pode se organizar com facilidade e rapidez.
        </>
      ),
      image: '/images/operation-image-1.png',
    },
