      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-16 font-semibold w-full max-w-6xl mx-auto px-2">
        {objectives.map((objetivo, index) => (
          <SlideIn key={index} delay={2} from='left'>
            <div className="bg-white shadow-xl text-white text-center rounded-lg h-[16rem] sm:h-[18.5rem] md:h-[21.5rem] lg:h-[20rem] w-full flex flex-col items-center justify-center card-shadow transition-all duration-500 transform hover:scale-105 hover:shadow-2xl">
