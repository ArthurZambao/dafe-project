...
export function Register() {
  return (
    <section className="w-full min-h-[700px] bg-[url('/svgs/lpage-register-bg.svg')] bg-no-repeat bg-cover bg-center flex flex-col sm:flex-row justify-center gap-20 px-6 sm:px-10 py-10">
