    ...
    <div className="flex flex-col gap-8 px-4 sm:px-10">
      {posts.map((post, index) => (
        <div
          ...
          className="cursor-pointer text-white flex flex-col sm:flex-row gap-6 py-6 sm:py-10 px-4 sm:px-8 hover:bg-[#d4d4d4d3] rounded-3xl transition-all duration-300 border sm:border-0 border-black"
        >
